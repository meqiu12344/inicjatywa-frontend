...
export const metadata: Metadata = {
  title: {
    default: "Wydarzenia Katolickie",
    template: "%s | Wydarzenia Katolickie",
  },
  description: "Odkryj wydarzenia katolickie w swojej okolicy. Rekolekcje, pielgrzymki, spotkania modlitewne i więcej.",
  keywords: ["wydarzenia katolickie", "rekolekcje", "pielgrzymki", "spotkania modlitewne", "kościół", "wiara"],
  authors: [{ name: "Inicjatywa Katolicka" }],
  openGraph: {
    type: "website",
    locale: "pl_PL",
    siteName: "Wydarzenia Katolickie",
  },
};
