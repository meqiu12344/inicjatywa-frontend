...
interface OrganizerProfilePageProps {
  ...
  initialEvents: { results: EventListItem[] };
...
export default function OrganizerProfilePage({ initialOrganizer, initialEvents, initialReviews }: OrganizerProfilePageProps) {
